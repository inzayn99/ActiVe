...
{{--                                <p class="card-description">--}}
                                    ...
                                    <div class="form-group">
                                        <label for="cat_name"><a style="color: red;">{{$errors->first('cat_name')}}</a></label>
                                        <input type="text" name="cat_name"  value="{{old('cat_name')}}"id="cat_name" class="form-control" placeholder="Category Name" >
                                    </div>

                                <div class="form-group">
                                    <label for="slug"><a style="color: red;">{{$errors->first('slug')}}</a></label>
                                    <input type="text" name="slug"  value="{{old('slug')}}"id="slug" class="form-control" placeholder="Slug" >
                                </div><br>
