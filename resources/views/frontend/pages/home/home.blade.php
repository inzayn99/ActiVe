                    ...
                    <div class="d-sm-flex align-items-center text-center text-sm-start">
                        ...
                        <div class="tiny-slider arrow-end arrow-xs arrow-white arrow-round arrow-md-none">
                            <div class="tiny-slider-inner"
                                 ...
                                 data-items="1">
                                <!-- Slider items -->
                                <div> <a href="index.html#" class="text-reset btn-link">The most common business debate isn't as black and white as you might think</a></div>
                                <div> <a href="index.html#" class="text-reset btn-link">How the 10 worst business fails of all time could have been prevented </a></div>
                                <div> <a href="index.html#" class="text-reset btn-link">The most common business debate isn't as black and white as you might think </a></div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="pt-4 pb-0 card-grid">
        <div class="container">
            <div class="row g-4">
                <!-- Left big card -->
                <div class="col-lg-6">
                    <div class="card card-overlay-bottom card-grid-lg card-bg-scale" style="background-image:url('frontend/assets/images/blog/1by1/01.jpg'); background-position: center left; background-size: cover;">
                        <!-- Card featured -->
                        ...
                        <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                            <div class="w-100 mt-auto">
                                <!-- Card category -->
                                <a href="index.html#" class="badge bg-danger mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Nepal</a>
                                <!-- Card title -->
                                        ...
                                        <div class="nav-link">
                                            <div class="d-flex align-items-center text-white position-relative">
                                                <div class="avatar avatar-sm">
                                                    <img class="avatar-img rounded-circle" src="{{url('frontend/assets/images/avatar/11.jpg')}}" alt="avatar">
                                                </div>
                                                <span class="ms-3">by <a href="index.html#" class="stretched-link text-reset btn-link">Zayn</a></span>
                                            </div>
                                        </div>
                                    </li>
                ...
                <div class="col-lg-6">
                    <div class="row g-4">
                        <!-- Card item START -->
                        <div class="col-12">
                            <div class="card card-overlay-bottom card-grid-sm card-bg-scale" style="background-image:url('frontend/assets/images/blog/1by1/02.jpg'); background-position: center left; background-size: cover;">
                                <!-- Card Image -->
                                <!-- Card Image overlay -->
                                <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                                    <div class="w-100 mt-auto">
                                        <!-- Card category -->
                                        <a href="index.html#" class="badge bg-warning mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Mountain</a>
                                        <!-- Card title -->
                                        ...
                                        <ul class="nav nav-divider text-white-force align-items-center d-none d-sm-inline-block">
                                            <li class="nav-item position-relative">
                                                <div class="nav-link">by <a href="index.html#" class="stretched-link text-reset btn-link">Bryan</a>
                                                </div>
                                            </li>
                        ...
                        <!-- Card item START -->
                        <div class="col-md-6">
                            <div class="card card-overlay-bottom card-grid-sm card-bg-scale" style="background-image:url('frontend/assets/images/blog/1by1/03.jpg'); background-position: center left; background-size: cover;">
                                <!-- Card Image overlay -->
                                <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                                    <div class="w-100 mt-auto">
                                        <!-- Card category -->
                                        <a href="index.html#" class="badge bg-success mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Kathmandu</a>
                                        <!-- Card title -->
                                        ...
                                        <ul class="nav nav-divider text-white-force align-items-center d-none d-sm-inline-block">
                                            <li class="nav-item position-relative">
                                                <div class="nav-link">by <a href="index.html#" class="stretched-link text-reset btn-link">Joan</a>
                                                </div>
                                            </li>
                        ...
                        <!-- Card item START -->
                        <div class="col-md-6">
                            <div class="card card-overlay-bottom card-grid-sm card-bg-scale" style="background-image:url('frontend/assets/images/blog/1by1/04.jpg'); background-position: center left; background-size: cover;">
                                <!-- Card Image overlay -->
                                <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                                    <div class="w-100 mt-auto">
                                        <!-- Card category -->
                                        <a href="index.html#" class="badge bg-info mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Travels</a>
                                        <!-- Card title -->
                                        <h4 class="text-white"><a href="post-single-4.html" class="btn-link stretched-link text-reset">15 reasons to choose startup</a></h4>
                                        <!-- Card info -->
                                        <ul class="nav nav-divider text-white-force align-items-center d-none d-sm-inline-block">
                                            <li class="nav-item position-relative">
                                                <div class="nav-link">by <a href="index.html#" class="stretched-link text-reset btn-link">Amanda</a>
                                                </div>
                                            </li>
            ...
            <div class="row">
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                ...
                                <div class="position-relative">
                                    <img class="card-img" src="{{url('frontend/assets/images/blog/4by3/01.jpg')}}" alt="Card image">
                                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                        <!-- Card overlay bottom -->
                                        <div class="w-100 mt-auto">
                                            <!-- Card category -->
                                            <a href="index.html#" class="badge bg-warning mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Politics</a>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="nav-link">
                                                <div class="d-flex align-items-center position-relative">
                                                    <div class="avatar avatar-xs">
                                                        <img class="avatar-img rounded-circle" src="{{url('frontend/assets/images/avatar/01.jpg')}}" alt="avatar">
                                                    </div>
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <!-- Card img -->
                                <div class="position-relative">
                                    <img class="card-img" src="{{url('frontend/assets/images/blog/4by3/06.jpg')}}" alt="Card image">
                                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                        <!-- Card overlay Top -->
                                        ...
                                        <div class="w-100 mt-auto">
                                            <!-- Card category -->
                                            <a href="index.html#" class="badge bg-danger mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Advantures</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body px-0 pt-3">
                                    ...
                                    <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
                                        <li class="nav-item">
                                            <div class="nav-link">
                                                <div class="d-flex align-items-center position-relative">
                                                    <div class="avatar avatar-xs">
                                                        <img class="avatar-img rounded-circle" src="{{url('frontend/assets/images/avatar/02.jpg')}}" alt="avatar">
                                                    </div>
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <!-- Card img -->
                                <div class="position-relative">
                                    <img class="card-img" src="{{url('frontend/assets/images/blog/4by3/03.jpg')}}" alt="Card image">
                                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                        <!-- Card overlay bottom -->
                                        <div class="w-100 mt-auto">
                                            <!-- Card category -->
                                            <a href="index.html#" class="badge bg-success mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Culture</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body px-0 pt-3">
                                    ...
                                    <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
                                        <li class="nav-item">
                                            <div class="nav-link">
                                                <div class="d-flex align-items-center position-relative">
                                                    <div class="avatar avatar-xs">
                                                        <img class="avatar-img rounded-circle" src="{{url('frontend/assets/images/avatar/03.jpg')}}" alt="avatar">
                                                    </div>
                                                    <span class="ms-3">by <a href="index.html#" class="stretched-link text-reset btn-link">Bryan</a></span>
                                                </div>
                                            </div>
                                        </li>
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <!-- Card img -->
                                <div class="position-relative">
                                    <img class="card-img" src="{{url('frontend/assets/images/blog/4by3/04.jpg')}}" alt="Card image">
                                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                        <!-- Card overlay bottom -->
                                        <div class="w-100 mt-auto">
                                            <!-- Card category -->
                                            <a href="index.html#" class="badge bg-primary mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>City</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body px-0 pt-3">
                                        ...
                                        <li class="nav-item">
                                            <div class="nav-link">
                                                <div class="d-flex align-items-center position-relative">
                                                    ...
                                                    <span class="ms-3">by <a href="index.html#" class="stretched-link text-reset btn-link">Billy</a></span>
                                                </div>
                                            </div>
                                        </li>
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <!-- Card img -->
                                <div class="position-relative">
                                    <img class="card-img" src="{{url('frontend/assets/images/blog/4by3/05.jpg')}}" alt="Card image">
                                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                        <!-- Card overlay Top -->
                                        <div class="w-100 mb-auto d-flex justify-content-end">
                                            <div class="text-end ms-auto">
                                        ...
                                        <div class="w-100 mt-auto">
                                            <!-- Card category -->
                                            <a href="index.html#" class="badge bg-info mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Nature</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body px-0 pt-3">
                                    ...
                                    <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
                                        <li class="nav-item">
                                            <div class="nav-link">
                                                <div class="d-flex align-items-center position-relative">
                                                    <div class="avatar avatar-xs">
                                                        <img class="avatar-img rounded-circle" src="{{url('frontend/assets/images/avatar/05.jpg')}}" alt="avatar">
                                                    </div>
                                                    <span class="ms-3">by <a href="index.html#" class="stretched-link text-reset btn-link">Jacqueline</a></span>
                                                </div>
                                            </div>
                                        </li>
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <!-- Card img -->
                                <div class="position-relative">
                                    <img class="card-img" src="{{url('frontend/assets/images/blog/4by3/12.jpg')}}" alt="Card image">
                                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                        <!-- Card overlay bottom -->
                                        <div class="w-100 mt-auto">
                                            <!-- Card category -->
                                            <a href="index.html#" class="badge bg-danger mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Photography</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body px-0 pt-3">
                                    ...
                                    <ul class="nav nav-divider align-items-center d-none d-sm-inline-block">
                                        <li class="nav-item">
                                            <div class="nav-link">
                                                <div class="d-flex align-items-center position-relative">
                                                    <div class="avatar avatar-xs">
                                                        <img class="avatar-img rounded-circle" src="{{url('frontend/assets/images/avatar/06.jpg')}}" alt="avatar">
                                                    </div>
                                                    <span class="ms-3">by <a href="index.html#" class="stretched-link text-reset btn-link">Carolyn</a></span>
                                                </div>
                                            </div>
                                        </li>
                ...
                <div class="col-lg-3 mt-5 mt-lg-0">
                    <div data-sticky data-margin-top="80" data-sticky-for="767">
                        ...
                        <div class="row g-2">
                            <div class="col-4">
                                <a href="index.html#" class="bg-facebook rounded text-center text-white-force p-3 d-block">
                            ...
                            <div class="col-4">
                                <a href="index.html#" class="bg-instagram-gradient rounded text-center text-white-force p-3 d-block">
                            ...
                            <div class="col-4">
                                <a href="index.html#" class="bg-youtube rounded text-center text-white-force p-3 d-block">
                        ...
                        <div>
                            ...
                            <div class="text-center mt-3">
                                <a href="index.html#" class="fw-bold text-body text-primary-hover"><u>View all categories</u></a>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-lg-12">
                                ...
                                <div class="card mb-3">
                                    <div class="row g-3">
                                        <div class="col-4">
                                            <img class="rounded" src="{{url('frontend/assets/images/blog/4by3/thumb/03.jpg')}}" alt="">
                                        </div>
                                        <div class="col-8">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="mb-4 d-md-flex justify-content-between align-items-center">
                        ...
                        <a href="index.html#" class="text-body small"><u>Content by: Bootstrap</u></a>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                        ...
                                        <!-- Card overlay bottom -->
                                        <div class="w-100 mt-auto">
                                            <a href="index.html#" class="badge bg-info mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Marketing</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body px-0 pt-3">
                            ...
                            <div class="card">
                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                        <!-- Card overlay bottom -->
                                        <div class="w-100 mt-auto">
                                            <a href="index.html#" class="badge bg-danger mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Sports</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body px-0 pt-3">
                                        ...
                                        <li class="nav-item">
                                            <div class="nav-link">
                                                <div class="d-flex align-items-center position-relative">
                                                    ...
                                                    <span class="ms-3">by <a href="index.html#" class="stretched-link text-reset btn-link">Joan</a></span>
                                                </div>
                                            </div>
                                        </li>
                            ...
                            <div class="card">
                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                        <!-- Card overlay bottom -->
                                        <div class="w-100 mt-auto">
                                            <a href="index.html#" class="badge bg-success mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Marketing</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body px-0 pt-3">
                            ...
                            <div class="card">
                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                        <!-- Card overlay bottom -->
                                        <div class="w-100 mt-auto">
                                            <a href="index.html#" class="badge bg-warning mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Technology</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body px-0 pt-3">
